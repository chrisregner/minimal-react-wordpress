...
const PostItem = ({
  id, title, content, modified, date, featuredMedia, tags, hasReadMore, url,
}) => {
  ...
  return <section className='pb5'>
    ...
    <div className='ph3 ph4-ns'>
      {/* Title */}
      <Link data-test='title-link' to={url} className='hover-muted'>
      ...
      {/* Post Link */}
      {hasReadMore !== false && <Link data-test='read-more-link' to={url} className='button-primary'>Read More</Link>}
